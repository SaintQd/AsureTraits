...
@MythicMechanic(author = "SaintQd", name = "asureaddtrait")
class AsureAddTraitMechanic(event : MythicMechanicLoadEvent) : ITargetedEntitySkill {
    ...
    override fun castAtEntity(
        ...
        AsureUtils.sendDebugMessage(3,"MythicMobsMechanic: asureaddtrait")
