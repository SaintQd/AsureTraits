package org.saintqd.asuretraits.storage
...
import org.saintqd.asuretraits.utils.JDBIUtils
...
class MySqlJdbiStorage : DataStorage {
    ...
    fun setupDataSource() {
        dataSource.jdbcUrl = AsureTraits.inst().config.getString("Database.Url","")
        dataSource.username = AsureTraits.inst().config.getString("Database.Username","")
        dataSource.password = AsureTraits.inst().config.getString("Database.Password","")
    }
    ...
    init {
        ...
        var tablePrefix = AsureTraits.inst().config.getString("Database.TablePrefix","")!!
