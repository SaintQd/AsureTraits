...
@AsureTraitType("on_interact")
class OnInteractAction(name : String, config : ConfigurationSection) : TraitAction(name,config), BindableAction {
    ...
    private val interactableActionName = config.getString("Action","none")!!
