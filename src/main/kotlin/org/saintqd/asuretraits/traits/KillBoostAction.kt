...
class KillBoostAction(name : String, config : ConfigurationSection) : TraitAction(name,config) {
    ...
    private fun setAbsorption(player : Player, amount : Double) {
        ...
        Bukkit.getScheduler().scheduleSyncDelayedTask(AsureTraits.inst(), {
    ...
    companion object {
        ...
        val ACTION_KEY = NamespacedKey(AsureTraits.inst(),"kill_boost")
        val SAVED_HEALTH_KEY = NamespacedKey(AsureTraits.inst(),"kill_boost_saved_health")
